...
public class DeviceDefinitionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DeviceDefinitionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWorkerAccess().getGroup_4(), "rule__Worker__Group_4__0");
			...
			builder.put(grammarAccess.getWorkerAccess().getMacAssignment_3_1(), "rule__Worker__MacAssignment_3_1");
			builder.put(grammarAccess.getWorkerAccess().getSleepTimeAssignment_4_2(), "rule__Worker__SleepTimeAssignment_4_2");
			builder.put(grammarAccess.getWorkerAccess().getTimeUnitAssignment_4_3(), "rule__Worker__TimeUnitAssignment_4_3");
			builder.put(grammarAccess.getWorkerAccess().getDevicesAssignment_5(), "rule__Worker__DevicesAssignment_5");
			...
			builder.put(grammarAccess.getSensorAccess().getGraphAssignment_8_1(), "rule__Sensor__GraphAssignment_8_1");
