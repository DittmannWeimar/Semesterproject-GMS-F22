...
public class DeviceDefinitionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DeviceDefinitionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGatewayAccess().getGroup_9(), "rule__Gateway__Group_9__0");
			...
			builder.put(grammarAccess.getWorkerAccess().getGroup_11(), "rule__Worker__Group_11__0");
			...
			builder.put(grammarAccess.getGatewayAccess().getMacAssignment_5_1(), "rule__Gateway__MacAssignment_5_1");
			builder.put(grammarAccess.getGatewayAccess().getChannelAssignment_7(), "rule__Gateway__ChannelAssignment_7");
			builder.put(grammarAccess.getGatewayAccess().getErrorLedAssignment_8_2(), "rule__Gateway__ErrorLedAssignment_8_2");
			builder.put(grammarAccess.getGatewayAccess().getRetriesAssignment_9_1(), "rule__Gateway__RetriesAssignment_9_1");
			builder.put(grammarAccess.getGatewayAccess().getDelayAssignment_9_4(), "rule__Gateway__DelayAssignment_9_4");
			builder.put(grammarAccess.getGatewayAccess().getDelayTimeUnitAssignment_9_5(), "rule__Gateway__DelayTimeUnitAssignment_9_5");
			builder.put(grammarAccess.getGatewayAccess().getWorkersAssignment_10(), "rule__Gateway__WorkersAssignment_10");
			...
			builder.put(grammarAccess.getWorkerAccess().getPreferredAssignment_5_1(), "rule__Worker__PreferredAssignment_5_1");
			builder.put(grammarAccess.getWorkerAccess().getSleepTimeAssignment_8(), "rule__Worker__SleepTimeAssignment_8");
			builder.put(grammarAccess.getWorkerAccess().getTimeUnitAssignment_9(), "rule__Worker__TimeUnitAssignment_9");
			builder.put(grammarAccess.getWorkerAccess().getErrorLedAssignment_10_2(), "rule__Worker__ErrorLedAssignment_10_2");
			builder.put(grammarAccess.getWorkerAccess().getRetriesAssignment_11_1(), "rule__Worker__RetriesAssignment_11_1");
			builder.put(grammarAccess.getWorkerAccess().getDelayAssignment_11_4(), "rule__Worker__DelayAssignment_11_4");
			builder.put(grammarAccess.getWorkerAccess().getDelayTimeUnitAssignment_11_5(), "rule__Worker__DelayTimeUnitAssignment_11_5");
			builder.put(grammarAccess.getWorkerAccess().getDevicesAssignment_12(), "rule__Worker__DevicesAssignment_12");
