...
public class DeviceDefinitionParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DeviceDefinitionGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSystemAccess().getImportsAssignment_0(), "rule__System__ImportsAssignment_0");
			builder.put(grammarAccess.getSystemAccess().getGatewayAssignment_3(), "rule__System__GatewayAssignment_3");
			...
			builder.put(grammarAccess.getSensorAccess().getBehaviorAssignment_10_1(), "rule__Sensor__BehaviorAssignment_10_1");
			builder.put(grammarAccess.getSensorAccess().getPredicateAssignment_11_2(), "rule__Sensor__PredicateAssignment_11_2");
			builder.put(grammarAccess.getSensorAccess().getGraphAssignment_12_1(), "rule__Sensor__GraphAssignment_12_1");
			...
			builder.put(grammarAccess.getSensorOutputAccess().getBindingAssignment_3(), "rule__SensorOutput__BindingAssignment_3");
			...
			builder.put(grammarAccess.getActuatorAccess().getExpAssignment_10(), "rule__Actuator__ExpAssignment_10");
			builder.put(grammarAccess.getSettingAccess().getBindingAssignment_1(), "rule__Setting__BindingAssignment_1");
