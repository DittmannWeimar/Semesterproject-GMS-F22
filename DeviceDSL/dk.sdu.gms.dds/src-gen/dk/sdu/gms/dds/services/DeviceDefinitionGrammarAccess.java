...
public class DeviceDefinitionGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class SystemElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cWifiKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cWifiSsidAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cWifiSsidSTRINGTerminalRuleCall_4_0 = (RuleCall)cWifiSsidAssignment_4.eContents().get(0);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cWithKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Keyword cPasswordKeyword_5_1 = (Keyword)cGroup_5.eContents().get(1);
		private final Assignment cWifiPasswordAssignment_5_2 = (Assignment)cGroup_5.eContents().get(2);
		private final RuleCall cWifiPasswordSTRINGTerminalRuleCall_5_2_0 = (RuleCall)cWifiPasswordAssignment_5_2.eContents().get(0);
		private final Keyword cMqttKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Assignment cMqttHostAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cMqttHostSTRINGTerminalRuleCall_7_0 = (RuleCall)cMqttHostAssignment_7.eContents().get(0);
		private final Group cGroup_8 = (Group)cGroup.eContents().get(8);
		private final Keyword cWithKeyword_8_0 = (Keyword)cGroup_8.eContents().get(0);
		private final Keyword cUsernameKeyword_8_1 = (Keyword)cGroup_8.eContents().get(1);
		private final Assignment cMqttUsernameAssignment_8_2 = (Assignment)cGroup_8.eContents().get(2);
		private final RuleCall cMqttUsernameSTRINGTerminalRuleCall_8_2_0 = (RuleCall)cMqttUsernameAssignment_8_2.eContents().get(0);
		private final Keyword cAndKeyword_8_3 = (Keyword)cGroup_8.eContents().get(3);
		private final Keyword cPasswordKeyword_8_4 = (Keyword)cGroup_8.eContents().get(4);
		private final Assignment cMqttPasswordAssignment_8_5 = (Assignment)cGroup_8.eContents().get(5);
		private final RuleCall cMqttPasswordSTRINGTerminalRuleCall_8_5_0 = (RuleCall)cMqttPasswordAssignment_8_5.eContents().get(0);
		private final Assignment cGatewayAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cGatewayGatewayParserRuleCall_9_0 = (RuleCall)cGatewayAssignment_9.eContents().get(0);
		private final Assignment cGraphsAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cGraphsGraphParserRuleCall_10_0 = (RuleCall)cGraphsAssignment_10.eContents().get(0);
		...
		//'wifi'
		public Keyword getWifiKeyword_3() { return cWifiKeyword_3; }
		
		//wifiSsid = STRING
		public Assignment getWifiSsidAssignment_4() { return cWifiSsidAssignment_4; }
		
		//STRING
		public RuleCall getWifiSsidSTRINGTerminalRuleCall_4_0() { return cWifiSsidSTRINGTerminalRuleCall_4_0; }
		...
		//'password'
		public Keyword getPasswordKeyword_5_1() { return cPasswordKeyword_5_1; }
		
		//wifiPassword = STRING
		public Assignment getWifiPasswordAssignment_5_2() { return cWifiPasswordAssignment_5_2; }
		
		//STRING
		public RuleCall getWifiPasswordSTRINGTerminalRuleCall_5_2_0() { return cWifiPasswordSTRINGTerminalRuleCall_5_2_0; }
		
		//'mqtt'
		public Keyword getMqttKeyword_6() { return cMqttKeyword_6; }
		
		//mqttHost = STRING
		public Assignment getMqttHostAssignment_7() { return cMqttHostAssignment_7; }
		
		//STRING
		public RuleCall getMqttHostSTRINGTerminalRuleCall_7_0() { return cMqttHostSTRINGTerminalRuleCall_7_0; }
		...
		//'username'
		public Keyword getUsernameKeyword_8_1() { return cUsernameKeyword_8_1; }
		
		//mqttUsername = STRING
		public Assignment getMqttUsernameAssignment_8_2() { return cMqttUsernameAssignment_8_2; }
		
		//STRING
		public RuleCall getMqttUsernameSTRINGTerminalRuleCall_8_2_0() { return cMqttUsernameSTRINGTerminalRuleCall_8_2_0; }
		
		//'and'
		public Keyword getAndKeyword_8_3() { return cAndKeyword_8_3; }
		
		//'password'
		public Keyword getPasswordKeyword_8_4() { return cPasswordKeyword_8_4; }
		
		//mqttPassword = STRING
		public Assignment getMqttPasswordAssignment_8_5() { return cMqttPasswordAssignment_8_5; }
		
		//STRING
		public RuleCall getMqttPasswordSTRINGTerminalRuleCall_8_5_0() { return cMqttPasswordSTRINGTerminalRuleCall_8_5_0; }
		
		//gateway = Gateway
		public Assignment getGatewayAssignment_9() { return cGatewayAssignment_9; }
		
		//Gateway
		public RuleCall getGatewayGatewayParserRuleCall_9_0() { return cGatewayGatewayParserRuleCall_9_0; }
		
		//graphs += Graph*
		public Assignment getGraphsAssignment_10() { return cGraphsAssignment_10; }
		
		//Graph
		public RuleCall getGraphsGraphParserRuleCall_10_0() { return cGraphsGraphParserRuleCall_10_0; }
	}
	...
	public class GatewayElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cMacAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cMacMACTerminalRuleCall_5_1_0 = (RuleCall)cMacAssignment_5_1.eContents().get(0);
		private final Keyword cChannelKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Assignment cChannelAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cChannelINTTerminalRuleCall_7_0 = (RuleCall)cChannelAssignment_7.eContents().get(0);
		private final Group cGroup_8 = (Group)cGroup.eContents().get(8);
		private final Keyword cErrorKeyword_8_0 = (Keyword)cGroup_8.eContents().get(0);
		private final Keyword cLightKeyword_8_1 = (Keyword)cGroup_8.eContents().get(1);
		private final Assignment cErrorLedAssignment_8_2 = (Assignment)cGroup_8.eContents().get(2);
		private final RuleCall cErrorLedINTTerminalRuleCall_8_2_0 = (RuleCall)cErrorLedAssignment_8_2.eContents().get(0);
		private final Group cGroup_9 = (Group)cGroup.eContents().get(9);
		private final Keyword cRetriesKeyword_9_0 = (Keyword)cGroup_9.eContents().get(0);
		private final Assignment cRetriesAssignment_9_1 = (Assignment)cGroup_9.eContents().get(1);
		private final RuleCall cRetriesINTTerminalRuleCall_9_1_0 = (RuleCall)cRetriesAssignment_9_1.eContents().get(0);
		private final Keyword cWithKeyword_9_2 = (Keyword)cGroup_9.eContents().get(2);
		private final Keyword cDelayKeyword_9_3 = (Keyword)cGroup_9.eContents().get(3);
		private final Assignment cDelayAssignment_9_4 = (Assignment)cGroup_9.eContents().get(4);
		private final RuleCall cDelayNumberPrimitiveParserRuleCall_9_4_0 = (RuleCall)cDelayAssignment_9_4.eContents().get(0);
		private final Assignment cDelayTimeUnitAssignment_9_5 = (Assignment)cGroup_9.eContents().get(5);
		private final RuleCall cDelayTimeUnitTimeUnitParserRuleCall_9_5_0 = (RuleCall)cDelayTimeUnitAssignment_9_5.eContents().get(0);
		private final Assignment cWorkersAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cWorkersWorkerParserRuleCall_10_0 = (RuleCall)cWorkersAssignment_10.eContents().get(0);
		...
		//mac += MAC
		public Assignment getMacAssignment_5_1() { return cMacAssignment_5_1; }
		
		//MAC
		public RuleCall getMacMACTerminalRuleCall_5_1_0() { return cMacMACTerminalRuleCall_5_1_0; }
		
		//'channel'
		public Keyword getChannelKeyword_6() { return cChannelKeyword_6; }
		
		//channel = INT
		public Assignment getChannelAssignment_7() { return cChannelAssignment_7; }
		
		//INT
		public RuleCall getChannelINTTerminalRuleCall_7_0() { return cChannelINTTerminalRuleCall_7_0; }
		...
		//'light'
		public Keyword getLightKeyword_8_1() { return cLightKeyword_8_1; }
		
		//errorLed += INT
		public Assignment getErrorLedAssignment_8_2() { return cErrorLedAssignment_8_2; }
		
		//INT
		public RuleCall getErrorLedINTTerminalRuleCall_8_2_0() { return cErrorLedINTTerminalRuleCall_8_2_0; }
		
		//('retries' retries += INT 'with' 'delay' delay += NumberPrimitive delayTimeUnit = TimeUnit)?
		public Group getGroup_9() { return cGroup_9; }
		
		//'retries'
		public Keyword getRetriesKeyword_9_0() { return cRetriesKeyword_9_0; }
		
		//retries += INT
		public Assignment getRetriesAssignment_9_1() { return cRetriesAssignment_9_1; }
		
		//INT
		public RuleCall getRetriesINTTerminalRuleCall_9_1_0() { return cRetriesINTTerminalRuleCall_9_1_0; }
		
		//'with'
		public Keyword getWithKeyword_9_2() { return cWithKeyword_9_2; }
		
		//'delay'
		public Keyword getDelayKeyword_9_3() { return cDelayKeyword_9_3; }
		
		//delay += NumberPrimitive
		public Assignment getDelayAssignment_9_4() { return cDelayAssignment_9_4; }
		
		//NumberPrimitive
		public RuleCall getDelayNumberPrimitiveParserRuleCall_9_4_0() { return cDelayNumberPrimitiveParserRuleCall_9_4_0; }
		
		//delayTimeUnit = TimeUnit
		public Assignment getDelayTimeUnitAssignment_9_5() { return cDelayTimeUnitAssignment_9_5; }
		
		//TimeUnit
		public RuleCall getDelayTimeUnitTimeUnitParserRuleCall_9_5_0() { return cDelayTimeUnitTimeUnitParserRuleCall_9_5_0; }
		
		//workers += Worker+
		public Assignment getWorkersAssignment_10() { return cWorkersAssignment_10; }
		
		//Worker
		public RuleCall getWorkersWorkerParserRuleCall_10_0() { return cWorkersWorkerParserRuleCall_10_0; }
	}
	public class WorkerElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMacMACTerminalRuleCall_4_0 = (RuleCall)cMacAssignment_4.eContents().get(0);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cPreferredGatewayKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Assignment cPreferredAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cPreferredINTTerminalRuleCall_5_1_0 = (RuleCall)cPreferredAssignment_5_1.eContents().get(0);
		private final Keyword cSleepKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Keyword cForKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Assignment cSleepTimeAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cSleepTimeNumberPrimitiveParserRuleCall_8_0 = (RuleCall)cSleepTimeAssignment_8.eContents().get(0);
		private final Assignment cTimeUnitAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cTimeUnitTimeUnitParserRuleCall_9_0 = (RuleCall)cTimeUnitAssignment_9.eContents().get(0);
		private final Group cGroup_10 = (Group)cGroup.eContents().get(10);
		private final Keyword cErrorKeyword_10_0 = (Keyword)cGroup_10.eContents().get(0);
		private final Keyword cLightKeyword_10_1 = (Keyword)cGroup_10.eContents().get(1);
		private final Assignment cErrorLedAssignment_10_2 = (Assignment)cGroup_10.eContents().get(2);
		private final RuleCall cErrorLedINTTerminalRuleCall_10_2_0 = (RuleCall)cErrorLedAssignment_10_2.eContents().get(0);
		private final Group cGroup_11 = (Group)cGroup.eContents().get(11);
		private final Keyword cRetriesKeyword_11_0 = (Keyword)cGroup_11.eContents().get(0);
		private final Assignment cRetriesAssignment_11_1 = (Assignment)cGroup_11.eContents().get(1);
		private final RuleCall cRetriesINTTerminalRuleCall_11_1_0 = (RuleCall)cRetriesAssignment_11_1.eContents().get(0);
		private final Keyword cWithKeyword_11_2 = (Keyword)cGroup_11.eContents().get(2);
		private final Keyword cDelayKeyword_11_3 = (Keyword)cGroup_11.eContents().get(3);
		private final Assignment cDelayAssignment_11_4 = (Assignment)cGroup_11.eContents().get(4);
		private final RuleCall cDelayNumberPrimitiveParserRuleCall_11_4_0 = (RuleCall)cDelayAssignment_11_4.eContents().get(0);
		private final Assignment cDelayTimeUnitAssignment_11_5 = (Assignment)cGroup_11.eContents().get(5);
		private final RuleCall cDelayTimeUnitTimeUnitParserRuleCall_11_5_0 = (RuleCall)cDelayTimeUnitAssignment_11_5.eContents().get(0);
		private final Assignment cDevicesAssignment_12 = (Assignment)cGroup.eContents().get(12);
		private final RuleCall cDevicesDeviceParserRuleCall_12_0 = (RuleCall)cDevicesAssignment_12.eContents().get(0);
		...
		//'preferred gateway'
		public Keyword getPreferredGatewayKeyword_5_0() { return cPreferredGatewayKeyword_5_0; }
		
		//preferred=INT
		public Assignment getPreferredAssignment_5_1() { return cPreferredAssignment_5_1; }
		
		//INT
		public RuleCall getPreferredINTTerminalRuleCall_5_1_0() { return cPreferredINTTerminalRuleCall_5_1_0; }
		
		//'sleep'
		public Keyword getSleepKeyword_6() { return cSleepKeyword_6; }
		
		//'for'
		public Keyword getForKeyword_7() { return cForKeyword_7; }
		
		//sleepTime = NumberPrimitive
		public Assignment getSleepTimeAssignment_8() { return cSleepTimeAssignment_8; }
		
		//NumberPrimitive
		public RuleCall getSleepTimeNumberPrimitiveParserRuleCall_8_0() { return cSleepTimeNumberPrimitiveParserRuleCall_8_0; }
		
		//timeUnit = TimeUnit
		public Assignment getTimeUnitAssignment_9() { return cTimeUnitAssignment_9; }
		
		//TimeUnit
		public RuleCall getTimeUnitTimeUnitParserRuleCall_9_0() { return cTimeUnitTimeUnitParserRuleCall_9_0; }
		
		//('error' 'light' errorLed += INT)?
		public Group getGroup_10() { return cGroup_10; }
		
		//'error'
		public Keyword getErrorKeyword_10_0() { return cErrorKeyword_10_0; }
		
		//'light'
		public Keyword getLightKeyword_10_1() { return cLightKeyword_10_1; }
		
		//errorLed += INT
		public Assignment getErrorLedAssignment_10_2() { return cErrorLedAssignment_10_2; }
		
		//INT
		public RuleCall getErrorLedINTTerminalRuleCall_10_2_0() { return cErrorLedINTTerminalRuleCall_10_2_0; }
		
		//('retries' retries += INT 'with' 'delay' delay += NumberPrimitive delayTimeUnit = TimeUnit)?
		public Group getGroup_11() { return cGroup_11; }
		
		//'retries'
		public Keyword getRetriesKeyword_11_0() { return cRetriesKeyword_11_0; }
		
		//retries += INT
		public Assignment getRetriesAssignment_11_1() { return cRetriesAssignment_11_1; }
		
		//INT
		public RuleCall getRetriesINTTerminalRuleCall_11_1_0() { return cRetriesINTTerminalRuleCall_11_1_0; }
		
		//'with'
		public Keyword getWithKeyword_11_2() { return cWithKeyword_11_2; }
		
		//'delay'
		public Keyword getDelayKeyword_11_3() { return cDelayKeyword_11_3; }
		
		//delay += NumberPrimitive
		public Assignment getDelayAssignment_11_4() { return cDelayAssignment_11_4; }
		
		//NumberPrimitive
		public RuleCall getDelayNumberPrimitiveParserRuleCall_11_4_0() { return cDelayNumberPrimitiveParserRuleCall_11_4_0; }
		
		//delayTimeUnit = TimeUnit
		public Assignment getDelayTimeUnitAssignment_11_5() { return cDelayTimeUnitAssignment_11_5; }
		
		//TimeUnit
		public RuleCall getDelayTimeUnitTimeUnitParserRuleCall_11_5_0() { return cDelayTimeUnitTimeUnitParserRuleCall_11_5_0; }
		
		//devices += Device*
		public Assignment getDevicesAssignment_12() { return cDevicesAssignment_12; }
		
		//Device
		public RuleCall getDevicesDeviceParserRuleCall_12_0() { return cDevicesDeviceParserRuleCall_12_0; }
	}
	...
	public class TimeUnitElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final Action cMillisecondAction_0_0 = (Action)cGroup_0.eContents().get(0);
		private final Alternatives cAlternatives_0_1 = (Alternatives)cGroup_0.eContents().get(1);
		private final Keyword cMillisecondKeyword_0_1_0 = (Keyword)cAlternatives_0_1.eContents().get(0);
		private final Keyword cMillisecondsKeyword_0_1_1 = (Keyword)cAlternatives_0_1.eContents().get(1);
		private final Keyword cMsKeyword_0_1_2 = (Keyword)cAlternatives_0_1.eContents().get(2);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cSecondAction_1_0 = (Action)cGroup_1.eContents().get(0);
		private final Alternatives cAlternatives_1_1 = (Alternatives)cGroup_1.eContents().get(1);
		private final Keyword cSecondKeyword_1_1_0 = (Keyword)cAlternatives_1_1.eContents().get(0);
		private final Keyword cSecondsKeyword_1_1_1 = (Keyword)cAlternatives_1_1.eContents().get(1);
		private final Keyword cSKeyword_1_1_2 = (Keyword)cAlternatives_1_1.eContents().get(2);
		private final Group cGroup_2 = (Group)cAlternatives.eContents().get(2);
		private final Action cMinuteAction_2_0 = (Action)cGroup_2.eContents().get(0);
		private final Alternatives cAlternatives_2_1 = (Alternatives)cGroup_2.eContents().get(1);
		private final Keyword cMinuteKeyword_2_1_0 = (Keyword)cAlternatives_2_1.eContents().get(0);
		private final Keyword cMinutesKeyword_2_1_1 = (Keyword)cAlternatives_2_1.eContents().get(1);
		private final Keyword cMKeyword_2_1_2 = (Keyword)cAlternatives_2_1.eContents().get(2);
		private final Group cGroup_3 = (Group)cAlternatives.eContents().get(3);
		private final Action cHourAction_3_0 = (Action)cGroup_3.eContents().get(0);
		private final Alternatives cAlternatives_3_1 = (Alternatives)cGroup_3.eContents().get(1);
		private final Keyword cHourKeyword_3_1_0 = (Keyword)cAlternatives_3_1.eContents().get(0);
		private final Keyword cHoursKeyword_3_1_1 = (Keyword)cAlternatives_3_1.eContents().get(1);
		private final Keyword cHKeyword_3_1_2 = (Keyword)cAlternatives_3_1.eContents().get(2);
		...
		//{Millisecond}
		public Action getMillisecondAction_0_0() { return cMillisecondAction_0_0; }
		
		//('millisecond' | 'milliseconds' | 'ms')
		public Alternatives getAlternatives_0_1() { return cAlternatives_0_1; }
		
		//'millisecond'
		public Keyword getMillisecondKeyword_0_1_0() { return cMillisecondKeyword_0_1_0; }
		
		//'milliseconds'
		public Keyword getMillisecondsKeyword_0_1_1() { return cMillisecondsKeyword_0_1_1; }
		
		//'ms'
		public Keyword getMsKeyword_0_1_2() { return cMsKeyword_0_1_2; }
		
		//{Second} ('second'|'seconds'|'s')
		public Group getGroup_1() { return cGroup_1; }
		
		//{Second}
		public Action getSecondAction_1_0() { return cSecondAction_1_0; }
		
		//('second'|'seconds'|'s')
		public Alternatives getAlternatives_1_1() { return cAlternatives_1_1; }
		
		//'second'
		public Keyword getSecondKeyword_1_1_0() { return cSecondKeyword_1_1_0; }
		
		//'seconds'
		public Keyword getSecondsKeyword_1_1_1() { return cSecondsKeyword_1_1_1; }
		
		//'s'
		public Keyword getSKeyword_1_1_2() { return cSKeyword_1_1_2; }
		
		//{Minute} ('minute'|'minutes'|'m')
		public Group getGroup_2() { return cGroup_2; }
		
		//{Minute}
		public Action getMinuteAction_2_0() { return cMinuteAction_2_0; }
		
		//('minute'|'minutes'|'m')
		public Alternatives getAlternatives_2_1() { return cAlternatives_2_1; }
		
		//'minute'
		public Keyword getMinuteKeyword_2_1_0() { return cMinuteKeyword_2_1_0; }
		
		//'minutes'
		public Keyword getMinutesKeyword_2_1_1() { return cMinutesKeyword_2_1_1; }
		
		//'m'
		public Keyword getMKeyword_2_1_2() { return cMKeyword_2_1_2; }
		
		//{Hour} ('hour'|'hours'|'h')
		public Group getGroup_3() { return cGroup_3; }
		
		//{Hour}
		public Action getHourAction_3_0() { return cHourAction_3_0; }
		
		//('hour'|'hours'|'h')
		public Alternatives getAlternatives_3_1() { return cAlternatives_3_1; }
		
		//'hour'
		public Keyword getHourKeyword_3_1_0() { return cHourKeyword_3_1_0; }
		
		//'hours'
		public Keyword getHoursKeyword_3_1_1() { return cHoursKeyword_3_1_1; }
		
		//'h'
		public Keyword getHKeyword_3_1_2() { return cHKeyword_3_1_2; }
	}
	...
	public class PrimitiveElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cBooleanFalseAction_1_0 = (Action)cGroup_1.eContents().get(0);
		private final Keyword cFALSEKeyword_1_1 = (Keyword)cGroup_1.eContents().get(1);
		private final RuleCall cNumberPrimitiveParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//{BooleanFalse}
		public Action getBooleanFalseAction_1_0() { return cBooleanFalseAction_1_0; }
		
		//'FALSE'
		public Keyword getFALSEKeyword_1_1() { return cFALSEKeyword_1_1; }
		
		//NumberPrimitive
		public RuleCall getNumberPrimitiveParserRuleCall_2() { return cNumberPrimitiveParserRuleCall_2; }
	}
	public class NumberPrimitiveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.gms.dds.DeviceDefinition.NumberPrimitive");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final Action cIntPrimitiveAction_0_0 = (Action)cGroup_0.eContents().get(0);
		private final Assignment cValueAssignment_0_1 = (Assignment)cGroup_0.eContents().get(1);
		private final RuleCall cValueINTTerminalRuleCall_0_1_0 = (RuleCall)cValueAssignment_0_1.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Action cDecimalPrimitiveAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		//{IntPrimitive}
		public Action getIntPrimitiveAction_0_0() { return cIntPrimitiveAction_0_0; }
		...
		//{DecimalPrimitive}
		public Action getDecimalPrimitiveAction_1_0() { return cDecimalPrimitiveAction_1_0; }
	...
	private final NumberPrimitiveElements pNumberPrimitive;
	...
	public DeviceDefinitionGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pNumberPrimitive = new NumberPrimitiveElements();
	...
	//    {IntPrimitive} value=INT | {DecimalPrimitive} value = DECIMAL
	//;
	public NumberPrimitiveElements getNumberPrimitiveAccess() {
		return pNumberPrimitive;
	}
	
	public ParserRule getNumberPrimitiveRule() {
		return getNumberPrimitiveAccess().getRule();
	}
