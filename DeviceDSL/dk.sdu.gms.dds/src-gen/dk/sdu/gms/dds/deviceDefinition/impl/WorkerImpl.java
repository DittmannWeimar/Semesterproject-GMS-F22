 ...
 *   <li>{@link dk.sdu.gms.dds.deviceDefinition.impl.WorkerImpl#getPreferred <em>Preferred</em>}</li>
...
public class WorkerImpl extends MinimalEObjectImpl.Container implements Worker
{
  ...
  /**
   * The default value of the '{@link #getPreferred() <em>Preferred</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPreferred()
   * @generated
   * @ordered
   */
  protected static final int PREFERRED_EDEFAULT = 0;

  /**
   * The cached value of the '{@link #getPreferred() <em>Preferred</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPreferred()
   * @generated
   * @ordered
   */
  protected int preferred = PREFERRED_EDEFAULT;
   ...
   */
  @Override
  public void setPreferred(int newPreferred)
  {
    int oldPreferred = preferred;
    preferred = newPreferred;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceDefinitionPackage.WORKER__PREFERRED, oldPreferred, preferred));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case DeviceDefinitionPackage.WORKER__MAC:
        return getMac();
      case DeviceDefinitionPackage.WORKER__PREFERRED:
        return getPreferred();
      case DeviceDefinitionPackage.WORKER__SLEEP_TIME:
        return getSleepTime();
      case DeviceDefinitionPackage.WORKER__TIME_UNIT:
