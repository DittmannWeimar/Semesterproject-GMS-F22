...
public class WorkerGenerator {
  ...
  public static CharSequence generateCode(final Worker worker) {
    ...
    EList<String> _mac = Utils.gateway(worker).getMac();
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("      ");
    _builder.append("uint8_t* mac = gatewayAddress[i];");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("memcpy(gatewayInfo[i].peer_addr, mac, 6);");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("gatewayInfo[i].channel = ");
    int _channel_1 = Utils.gateway(worker).getChannel();
    _builder.append(_channel_1, "      ");
    _builder.append(";  ");
    _builder.newLineIfNotEmpty();
    _builder.append("      ");
    _builder.append("gatewayInfo[i].encrypt = false;");
    _builder.newLine();
    _builder.append("      ");
    _builder.newLine();
    _builder.append("      ");
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("if (esp_now_add_peer(&gatewayInfo[i]) != ESP_OK){");
    _builder.newLine();
    _builder.append("        ");
    ...
    int _size_2 = Utils.gateway(worker).getMac().size();
