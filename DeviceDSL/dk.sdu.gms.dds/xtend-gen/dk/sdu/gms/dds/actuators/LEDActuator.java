...
public class LEDActuator extends ActuatorDefinition {
  public LEDActuator() {
    this.type = "LED";
    this.pinCount = 1;
    this.requiredSettings = new String[] { "brightness" };
  }
  ...
  protected CharSequence generateEnableActuatorCode(final Actuator actuator, final CharSequence enabledBoolString) {
    ...
    if ((_type instanceof DAC)) {
      ...
      _builder.append(") * ");
      String _settingBindingBySettingName = Utils.getSettingBindingBySettingName(actuator, "brightness");
