 ...
 * <!-- end-user-doc -->
 * @see dk.gms.dsl.deviceDefinition.DeviceDefinitionPackage#getActuatorType()
 * @model
 * @generated
 */
public enum ActuatorType implements Enumerator
{
  ...
  /**
   * The '<em><b>Water Pump</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #WATER_PUMP_VALUE
   * @generated
   * @ordered
   */
  WATER_PUMP(1, "WaterPump", "WaterPump");
  ...
  /**
   * The '<em><b>Water Pump</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #WATER_PUMP
   ...
   * @ordered
   */
  public static final int WATER_PUMP_VALUE = 1;
  ...
  public static ActuatorType get(int value)
  {
    switch (value)
    {
      ...
      case WATER_PUMP_VALUE: return WATER_PUMP;
    }
    return null;
  }
