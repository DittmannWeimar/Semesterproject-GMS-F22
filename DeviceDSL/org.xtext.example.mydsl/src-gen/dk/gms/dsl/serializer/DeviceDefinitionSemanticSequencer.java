...
public class DeviceDefinitionSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == DeviceDefinitionPackage.eINSTANCE)
			...
			case DeviceDefinitionPackage.BINDING_REF:
				sequence_BindingRef(context, (BindingRef) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (type=ImportRef pins+=INT* pins+=INT* settings+=Setting* exp=Exp)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     BindingRef returns BindingRef
	 *     Exp returns BindingRef
	 *     Exp.Plus_1_0_0_0 returns BindingRef
	 *     Exp.Minus_1_0_1_0 returns BindingRef
	 *     Factor returns BindingRef
	 *     Factor.Mult_1_0_0_0 returns BindingRef
	 *     Factor.Div_1_0_1_0 returns BindingRef
	 *     Compare returns BindingRef
	 *     Compare.Greater_1_0_0_0 returns BindingRef
	 *     Compare.Lesser_1_0_1_0 returns BindingRef
	 *     CompareOrEquals returns BindingRef
	 *     CompareOrEquals.GreaterOrEquals_1_0_0_0 returns BindingRef
	 *     CompareOrEquals.LesserOrEquals_1_0_1_0 returns BindingRef
	 *     EqualsOrNotEquals returns BindingRef
	 *     EqualsOrNotEquals.Equals_1_0_0_0 returns BindingRef
	 *     EqualsOrNotEquals.NotEquals_1_0_1_0 returns BindingRef
	 *     AndOr returns BindingRef
	 *     AndOr.And_1_0_0_0 returns BindingRef
	 *     AndOr.Or_1_0_1_0 returns BindingRef
	 *     Primary returns BindingRef
	 *
	 * Constraint:
	 *     ref=[Binding|ID]
	 * </pre>
	 */
	protected void sequence_BindingRef(ISerializationContext context, BindingRef semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DeviceDefinitionPackage.Literals.BINDING_REF__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DeviceDefinitionPackage.Literals.BINDING_REF__REF));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getBindingRefAccess().getRefBindingIDTerminalRuleCall_0_1(), semanticObject.eGet(DeviceDefinitionPackage.Literals.BINDING_REF__REF, false));
		feeder.finish();
	}
	...
	protected void sequence_Graph(ISerializationContext context, Graph semanticObject) {
		...
		feeder.accept(grammarAccess.getGraphAccess().getTypeImportRefParserRuleCall_4_0(), semanticObject.getType());
	 ...
	 * <pre>
	 * Contexts:
	 *     ImportRef returns ImportRef
	 *
	 * Constraint:
	 *     ref=[Import|ID]
	 * </pre>
	 */
	protected void sequence_ImportRef(ISerializationContext context, ImportRef semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DeviceDefinitionPackage.Literals.IMPORT_REF__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DeviceDefinitionPackage.Literals.IMPORT_REF__REF));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImportRefAccess().getRefImportIDTerminalRuleCall_0_1(), semanticObject.eGet(DeviceDefinitionPackage.Literals.IMPORT_REF__REF, false));
		feeder.finish();
	}
	...
	protected void sequence_Import(ISerializationContext context, Import semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImportAccess().getNameIDTerminalRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_Setting(ISerializationContext context, Setting semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSettingAccess().getBindingBindingParserRuleCall_0_0(), semanticObject.getBinding());
		feeder.accept(grammarAccess.getSettingAccess().getValueINTTerminalRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (imports+=Import* name=ID gateway=Gateway graphs+=Graph*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID mac=MAC (sleepTime=INT timeUnit+=TimeUnit)? (broadcastTime=INT timeUnit+=TimeUnit)? (devices+=Sensor | devices+=Actuator)*)
	 * </pre>
	 */
