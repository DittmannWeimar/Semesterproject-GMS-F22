 ...
 * </p>
 * <ul>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.SampleBehaviorImpl#getType <em>Type</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.SampleBehaviorImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.SampleBehaviorImpl#getPins <em>Pins</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SampleBehaviorImpl extends MinimalEObjectImpl.Container implements SampleBehavior
{
  ...
  public NotificationChain basicSetType(ImportRef newType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DeviceDefinitionPackage.SAMPLE_BEHAVIOR__TYPE, oldType, newType);
  ...
  public void setType(ImportRef newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeviceDefinitionPackage.SAMPLE_BEHAVIOR__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DeviceDefinitionPackage.SAMPLE_BEHAVIOR__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DeviceDefinitionPackage.SAMPLE_BEHAVIOR__TYPE, newType, newType));
  }
