 ...
 * </p>
 * <ul>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getName <em>Name</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getMac <em>Mac</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getSleepTime <em>Sleep Time</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getTimeUnit <em>Time Unit</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getBroadcastTime <em>Broadcast Time</em>}</li>
 *   <li>{@link dk.gms.dsl.deviceDefinition.impl.WorkerImpl#getDevices <em>Devices</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkerImpl extends MinimalEObjectImpl.Container implements Worker
{
  ...
  public EList<EObject> getDevices()
  {
    if (devices == null)
    {
      devices = new EObjectContainmentEList<EObject>(EObject.class, this, DeviceDefinitionPackage.WORKER__DEVICES);
    }
    return devices;
  }
