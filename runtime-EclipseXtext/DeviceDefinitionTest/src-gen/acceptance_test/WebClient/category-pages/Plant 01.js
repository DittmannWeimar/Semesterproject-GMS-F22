...
const graph_ref1988239256_context = document.getElementById('chart-Soil Moisture').getContext('2d');
graph_ref1988239256_data = {
    labels: [],
    datasets: [{
    	            label: '',
    	            data: [],
...
graph_ref1988239256 = new Chart(graph_ref1988239256_context, {
    type: 'line',
    data: graph_ref1988239256_data,
    options: {
        scales: {
            y: {
                title: {
...
chartIdToData['chart-Soil Moisture'] = graph_ref1988239256_data;
chartIdToChart['chart-Soil Moisture'] = graph_ref1988239256;
...
chartIdToChartExtras['chart-Soil Moisture'].colors.push('rgba');
    ...
    MQTTConnect(mqtt => {
        // Make vars
var mqtt_topic_1272972193 = 'samples/58:BF:25:E0:77:98/10:97:BD:D5:3E:64/moisture,sample';
mqtt.subscribe(mqtt_topic_1272972193);
        ...
        mqtt.onMessageArrived = function (message) {
            ...
            xLabel = date.toLocaleTimeString();
    	        ...
    	        if(message.destinationName == mqtt_topic_1272972193) {
    	        		            graph_ref1988239256_data.labels.push(xLabel);
    	        		            graph_ref1988239256_data.datasets[0].data.push(message.payloadString);
    	        		            graph_ref1988239256.update();
    	        }
        }
    });
